...
describe('when querying for bids', () => {
  describe('and limit and offset are defined', () => {
    const query = getBidsQuery({ offset: 2, limit: 1 }, 'marketplace_squid_schema')
  ...
  describe('and the bidder filter is defined', () => {
    it('should add the filter to the query', () => {
      const query = getBidsQuery({ bidder: '0x1', offset: 1, limit: 1 }, 'marketplace_squid_schema')
  ...
  describe('and the seller filter is defined', () => {
    it('should add the filter to the query', () => {
      const query = getBidsQuery({ seller: '0x12', offset: 1, limit: 1 }, 'marketplace_squid_schema')
  ...
  describe('and the contract address filter is defined', () => {
    it('should add the filter to the query', () => {
      const query = getBidsQuery({ contractAddress: '0x123', offset: 1, limit: 1 }, 'marketplace_squid_schema')
  ...
  describe('and the token id filter is defined', () => {
    it('should add the filter to the query', () => {
      const query = getBidsQuery({ tokenId: 'a-token-id', offset: 1, limit: 1 }, 'marketplace_squid_schema')
  ...
  describe('and the item id filter is defined', () => {
    it('should add the filter to the query', () => {
      const query = getBidsQuery({ tokenId: 'an-item-id', offset: 1, limit: 1 }, 'marketplace_squid_schema')
      expect(query.text).toContain('LOWER(token_id) = LOWER($1)')
  ...
  describe('and the network is defined', () => {
    describe('and the network is MATIC', () => {
      it('should add the filter to the query', () => {
        const query = getBidsQuery({ network: Network.MATIC, offset: 1, limit: 1 }, 'marketplace_squid_schema')
    ...
    describe('and the network is ETHEREUM', () => {
      it('should add the filter to the query', () => {
        const query = getBidsQuery({ network: Network.ETHEREUM, offset: 1, limit: 1 }, 'marketplace_squid_schema')
        expect(query.text).toContain('network = ANY ($1)')
