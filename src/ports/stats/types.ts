...
export type StatsEstateFilters = Pick<
  NFTFilters,
  'isOnSale' | 'adjacentToRoad' | 'minDistanceToPlaza' | 'maxDistanceToPlaza' | 'minEstateSize' | 'maxEstateSize' | 'minPrice' | 'maxPrice'
>
...
export interface IStatsComponent {
  fetch(params: StatsResourceParams, filters: StatsResourceFilters): Promise<Stats>
}
