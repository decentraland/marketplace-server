import { Account, EmoteCategory, Network, Rarity, WearableCategory } from '@dcl/schemas'
...
export type RankingFragment = ItemsDayDataFragment | CreatorsDayDataFragment | CollectorsDayDataFragment
